...
odb_download_server () {
  #http://www.orientdb.org/portal/function/portal/download/robot-php-#@travi-ci.com/%20/%20/%20/%20/unknown/orientdb-community-#.#.#.tar.gz/false/false/mac
	#http://orientdb.com/download.php?email=unknown@unknown.com&file=orientdb-community-2.1.5.tar.gz&os=linux
  ...
  if [ $(odb_compare_version $ODB_VERSION 1.6.1) -ge 0 ]; then
    ...
    #ODB_PACKAGE_URL="http://www.orientdb.org/portal/function/portal/download/${DOWN_USER}/%20/%20/%20/%20/unknown/${ODB_PACKAGE}.${ODB_PACKAGE_EXT}/false/false/mac"
		ODB_PACKAGE_URL="http://orientdb.com/download.php?email=${DOWN_USER}&file=${ODB_PACKAGE}.${ODB_PACKAGE_EXT}&os=linux"
